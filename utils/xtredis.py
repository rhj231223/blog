...
import json
redis=StrictRedis(host='127.0.0.1',port=6379,password='2312231223')
...
class BBS_Redis(object):
    ...
    @classmethod
    def get(cls, key):
        if cls.__redis.get(key):
            return str(cls.__redis.get(key), encoding='utf8')
        else:
            return None
...
if __name__=='__main__':
    BBS_Redis.set('657930342@qq.com','324252',ex=10)
    # print(BBS_Redis.get('657930342@qq.com'))